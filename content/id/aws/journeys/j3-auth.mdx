...
Aplikasi catatan dari [J2](/id/aws/journeys/j2-rest-api) sekarang punya user. Setiap note milik user tertentu. Hanya pemilik yang bisa lihat dan hapus note miliknya.
...
Detail Cognito per fitur ada di halaman [Cognito](/id/aws/services/cognito) (segera).
