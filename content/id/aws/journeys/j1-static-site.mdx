...
Detail step-by-step deploy ke AWS asli ada di halaman service masing-masing ([S3](/id/aws/services/s3), CloudFront, [Route53](/id/aws/services/route53), ACM).
...
- Mau API endpoint juga? Lanjut ke [J2: REST API Serverless](/id/aws/journeys/j2-rest-api).
