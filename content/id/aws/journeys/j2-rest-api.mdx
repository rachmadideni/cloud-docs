...
Detail per service ada di halaman service masing-masing ([Lambda](/id/aws/services/lambda), API Gateway, [DynamoDB](/id/aws/services/dynamodb), [IAM](/id/aws/services/iam)).
...
- Mau frontend yang konsumsi API ini? Kombinasi [J1: Static Site](/id/aws/journeys/j1-static-site) plus API endpoint dari journey ini.
